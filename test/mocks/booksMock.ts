...
export const booksMock: IBookMock[] = [
  {
    ...
    publishedDate: "1937-09-21T00:00:00.000Z" as unknown as Date as unknown as Date,
    pageCount: 310,
    language: "Português",
    categories: [
      {
  ...
  },
  {
    ...
    description: "A terceira parte da jornada de Harry Potter no mundo da magia e em Hogwarts.",
    price: 39.9,
    stock: 200,
    publisher: "Rocco",
  ...
  },
  {
    ...
    description: "Uma distopia sombria sobre um regime totalitário que controla todos os aspectos da vida.",
    price: 35.5,
    stock: 180,
  ...
  },
  {
    ...
    description: "A saga da família Buendía na cidade fictícia de Macondo, misturando realidade e fantasia.",
    price: 49.9,
    stock: 120,
    publisher: "Record",
  ...
  },
  {
    ...
    description: "Um piloto encontra um pequeno príncipe que viaja de planeta em planeta em busca de respostas.",
    price: 29.9,
    stock: 300,
    publisher: "Agir",
  ...
  },
  {
    ...
    description: "A história de Elizabeth Bennet e Mr. Darcy, um dos casais mais icônicos da literatura.",
    price: 37.5,
    stock: 170,
  ...
  },
  {
    ...
    description: "As aventuras de um fidalgo que enlouquece após ler muitos romances de cavalaria.",
    price: 55.0,
    stock: 90,
  ...
  },
  {
    ...
    description: "Um estudante comete um assassinato e lida com as consequências psicológicas de seu crime.",
    price: 42.9,
    stock: 110,
  ...
  },
  {
    ...
    description: "A jornada de Frodo Bolseiro para destruir o Um Anel e salvar a Terra-média.",
    price: 59.9,
    stock: 140,
  ...
  },
  {
    ...
    description: "O primeiro livro da série que apresenta Harry Potter e seu ingresso no mundo da magia.",
    price: 34.9,
    stock: 250,
    publisher: "Rocco",
    publishedDate: "1997-06-26T00:00:00.000Z" as unknown as Date,
  ...
  },
  {
    ...
    description: "Uma sátira política sobre uma revolução dos animais contra os humanos.",
    price: 32.5,
    stock: 190,
    publisher: "Companhia das Letras",
  ...
  },
  {
    ...
    description: "Uma história de amor que atravessa décadas, repleta de paixão e nostalgia.",
    price: 47.9,
    stock: 130,
    publisher: "Record",
  ...
  },
  {
    ...
    description: "A mitologia por trás do mundo de O Senhor dos Anéis, contando a história da Terra-média.",
    price: 52.9,
    stock: 100,
    publisher: "HarperCollins",
  ...
  },
  {
    ...
    description: "O último livro da série, onde Harry enfrenta Voldemort em uma batalha final.",
    price: 44.9,
    stock: 180,
    publisher: "Rocco",
  ...
  },
  {
    ...
    description: "A história de Josef K., que é preso e processado por um crime que não conhece.",
    price: 38.5,
    stock: 160,
    publisher: "Companhia das Letras",
